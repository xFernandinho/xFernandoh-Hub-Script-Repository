...
local function createServerEntry(serverData, index)
    ...
    EntryStroke.Color = isCurrent and Color3.fromRGB(100, 255, 150) or (wasVisited and Color3.fromRGB(241, 196, 15) or Color3.fromRGB(50, 140, 90))
    EntryStroke.Thickness = (isCurrent or wasVisited) and 1.5 or 1
    EntryStroke.Transparency = (isCurrent or wasVisited) and 0.4 or 0.8
...
HistoryFrameCorner.CornerRadius = UDim.new(0, 14)
HistoryFrameCorner.Parent = HistoryFrame
local HistoryFrameStroke = Instance.new("UIStroke")
HistoryFrameStroke.Color = Color3.fromRGB(60, 160, 100)
HistoryFrameStroke.Thickness = 1
HistoryFrameStroke.Transparency = 0.6
HistoryFrameStroke.Parent = HistoryFrame
...
HistoryHeaderCorner.CornerRadius = UDim.new(0, 14)
HistoryHeaderCorner.Parent = HistoryHeader
local HistoryHeaderCover = Instance.new("Frame")
HistoryHeaderCover.Size = UDim2.new(1, 0, 0, 14)
HistoryHeaderCover.Position = UDim2.new(0, 0, 1, -14)
HistoryHeaderCover.BackgroundColor3 = Color3.fromRGB(22, 25, 27)
HistoryHeaderCover.BorderSizePixel = 0
HistoryHeaderCover.Parent = HistoryHeader
...
local HistoryCloseCorner = Instance.new("UICorner")
HistoryCloseCorner.CornerRadius = UDim.new(0, 8)
HistoryCloseCorner.Parent = HistoryCloseButton
...
local ResetHistoryCorner = Instance.new("UICorner")
ResetHistoryCorner.CornerRadius = UDim.new(0, 8)
ResetHistoryCorner.Parent = ResetHistoryButton
...
HistoryListPadding.PaddingTop = UDim.new(0, 8)
HistoryListPadding.PaddingBottom = UDim.new(0, 12)
HistoryListPadding.PaddingLeft = UDim.new(0, 8)
HistoryListPadding.PaddingRight = UDim.new(0, 8)
HistoryListPadding.Parent = HistoryList
...
local function History_CreateEntryRow(entry, index)
    ...
    RowStroke.Color = entry.favorite and Color3.fromRGB(241, 196, 15) or Color3.fromRGB(50, 140, 90)
    RowStroke.Thickness = entry.favorite and 1.5 or 1
    RowStroke.Transparency = 0.6
    RowStroke.Parent = Row
    local IdLabel = Instance.new("TextLabel")
    IdLabel.Size = UDim2.new(1, -170, 0, historyEntryHeight * 0.42)
    ...
    NoteBox.Size = UDim2.new(1, -170, 0, historyEntryHeight * 0.42)
    ...
    NoteBox.Parent = Row
    local NoteBoxPadding = Instance.new("UIPadding")
    NoteBoxPadding.PaddingLeft = UDim.new(0, 6)
    NoteBoxPadding.Parent = NoteBox
    local NoteBoxCorner = Instance.new("UICorner")
    NoteBoxCorner.CornerRadius = UDim.new(0, 6)
    NoteBoxCorner.Parent = NoteBox
...
local HistoryToggleCorner = Instance.new("UICorner")
HistoryToggleCorner.CornerRadius = UDim.new(0, 12)
HistoryToggleCorner.Parent = HistoryToggleButton
local HistoryToggleStroke = Instance.new("UIStroke")
HistoryToggleStroke.Color = Color3.fromRGB(80, 200, 130)
HistoryToggleStroke.Thickness = 1.5
HistoryToggleStroke.Transparency = 0.5
HistoryToggleStroke.Parent = HistoryToggleButton
